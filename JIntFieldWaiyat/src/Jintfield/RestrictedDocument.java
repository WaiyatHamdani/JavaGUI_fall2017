...
public class RestrictedDocument extends PlainDocument{
    ...
    public void insertString(int offs, String str, AttributeSet a) throws BadLocationException{
            String jTextField = getText(0, getLength()); // getting JTextField value enter by user
            ...
            try {
                if (!jTextField.isEmpty()) { // check jTextField is not empty if Yes then
                    ...
                    proceed = val >= 0 && val <= 255; // return true or false value if input value between 0-255
                }
